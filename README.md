...
### Deployment Topology
Nginx represents the containerized edge for the frontend build and sits next to the backend container when that path is used.
```mermaid
graph LR
  subgraph Production
...
CI does not enforce a frontend coverage threshold.
